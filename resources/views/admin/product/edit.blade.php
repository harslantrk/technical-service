  ...
  {!! csrf_field() !!}
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <textarea type="text" class="textarea" style="width:100%;height:250px;resize:none;" id="exampleInputEmail1" placeholder="" name="description">{{$product->description}}</textarea>
      </div>
