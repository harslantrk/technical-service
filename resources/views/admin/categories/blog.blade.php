				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="/admin/categories"><i class="fa fa-folder-o"></i> Sayfa Kategorileri</a></li>
							<li class="active"><a href="/admin/categories/blog"><i class="fa fa-folder-o"></i> Blog Kategorileri</a></li>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Tüm Blog Kategorileri</h3>
						</div><!-- /.box-header -->
							...
							<table id="datatablo" class="table table-bordered table-hover">
								...
								@foreach($categories as $key => $value)
									<tr>
										...
										<td>
											<div class="btn-group">
												<button type="button" class="btn btn-info">İşlem</button>
