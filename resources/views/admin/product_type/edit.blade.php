        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{$product_types->product_type}} Türünü Güncelle</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{URL::to('/admin/product_type/update/'.$product_types->id)}}">
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="form-group">
                            <label class="control-label">Ürün Türü</label>
                            <input type="text" class="form-control" name="product_type" value="{{$product_types->product_type}}">
                        </div>
                    </div><!-- /.box-body -->
