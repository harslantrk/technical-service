...
<section class="content">	
  <div class="row">
      ...
      <div class="box box-primary" style="padding: 1%">
        ...
        <div class="box-body">
        <form class="form-inline" id="modules_update_form" method="POST">
        ...
        <div class='col-lg-9'><label>
        <input type='text' class='form-control' name='url' value='{{$data->url}}'/></label>
        ...
        <div class='col-lg-9'><label>
        <input type='text' class='form-control' name='priority' value='{{$data->priority}}'/></label>
        </div></div>
        ...
        <?php } ?>
          <label>
            <button class='btn btn-primary' id='modules_update_Btn'><i class="fa fa-save"></i> Kaydet</button>
          </label>
        </form>
      </div>
      </div>
