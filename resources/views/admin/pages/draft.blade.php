				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="/admin/pages/drafts"><i class="fa fa-folder-o"></i> Taslak Sayfalar</a></li>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Taslak Sayfalar</h3>
						</div><!-- /.box-header -->
								...
								@foreach($pages as $value)
									<tr>
										...
										<td>
											...
											<a href="/admin/pages-delete/{{$value->id}}" class="button btn btn-danger" onclick="silOnayla()"><i class="fa fa-trash"> Sil</i></a>
										</td>
									</tr>
									<?php $sayac++; ?>
								@endforeach
