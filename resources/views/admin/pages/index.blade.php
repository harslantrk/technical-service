				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							<li class="active"><a href="/admin/pages"><i class="fa fa-folder-o"></i> Aktif Sayfalar</a></li>
							<li><a href="/admin/pages/drafts"><i class="fa fa-folder-o"></i> Taslak Sayfalar</a></li>
							<li><a href="/admin/pages/deleted"><i class="fa fa-folder-o"></i> Silinen Sayfalar</a></li>
						</ul>
					</div><!-- /.box-body -->
				</div><!-- /. box -->
			</div><!-- /.col -->
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Tüm Sayfalar</h3>
						</div><!-- /.box-header -->
							...
							<table id="datatablo" class="table table-bordered table-hover">
								...
								@foreach($pages as $value)
									<tr>
										...
										<td>
											@if($deleg['u']==1)<a href="/admin/pages/edit/{{$value->id}}" class="button btn btn-success"><i class="fa fa-edit"> Düzenle</i></a>@endif
											@if($deleg['d']==1)<a class="button btn btn-danger" onclick="deleteApprove('/admin/pages/delete/{{$value->id}}')"><i class="fa fa-trash"> Sil</i></a>@endif
										</td>
									</tr>
									<?php $sayac++; ?>
								@endforeach
