        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{$brands->brand}} Markasını Güncelle</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{URL::to('/admin/brand/update/'.$brands->id)}}">
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="form-group">
                            <label class="control-label">Marka</label>
                            <input type="text" class="form-control" name="brand" value="{{$brands->brand}}">
                        </div>
                    </div><!-- /.box-body -->
