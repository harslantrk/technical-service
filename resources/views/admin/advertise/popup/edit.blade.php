...
<section class="content">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
		  <h3 class="box-title">Popup Reklamı Güncelleme</h3>
		</div><!-- /.box-header -->
		<!-- form start -->
		<form role="form" method="post" action="/admin/popup-update">
		{!! csrf_field() !!}
		  <div class="box-body">
			...
			<div class="form-group">
			  ...
			  <select name="page" class="form-control select2" style="width: 100%;">
				  <option {{($advertise->page_id == 0) ? "selected" : "" }} value="0" selected="selected">Sayfa Seçiniz</option>
		  ...
		  <div class="box-footer">
			...
			<a href="/admin/popup" class="button btn btn-warning"><i class="fa fa-undo"></i> Geri</a>
		  </div>
		</form>
	</div><!-- /.box -->
</section><!-- /.content -->
