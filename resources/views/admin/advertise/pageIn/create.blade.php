...
<section class="content">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
		  <h3 class="box-title">Yeni Sayfa İçi Reklamı Ekleme</h3>
		</div><!-- /.box-header -->
		<!-- form start -->
		<form role="form" method="post" action="/admin/page-in-save">
		{!! csrf_field() !!}
		  <div class="box-body">
		    ...
		    <div class="form-group">
		      ...
		      <label style="width: 10%"><input type="checkbox" name="top" class="minimal"> Üst</label>
		      <label style="width: 10%"><input type="checkbox" name="left" class="minimal"> Sol</label>
		      <label style="width: 10%"><input type="checkbox" name="inside" class="minimal"> İç</label>
		      <label style="width: 10%"><input type="checkbox" name="right" class="minimal"> Sağ</label>
		      <label style="width: 10%"><input type="checkbox" name="bottom" class="minimal"> Alt</label>
		    </div>
		    <div class="form-group">
