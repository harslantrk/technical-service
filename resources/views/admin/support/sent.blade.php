                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="{{URL::to('admin/support/sent')}}"><i class="fa fa-envelope-o"></i> Gönderilenler</a></li>
                                @if($deleg['d'] == 1)
                        ...
                        <div class="box-body">
                            <form role="form" action="{{URL::to('/admin/support/supportSave')}}" method="POST">
                                ...
                                <div class="modal-footer">
                                    <button onclick="cancelSupport()" type="button" class="btn btn-default" data-dismiss="modal">İptal</button>
                                    <button id="supportSaveBtn" type="submit" class="btn btn-primary" disabled>Mesajı Gönder</button>
                                </div>
                            </form>
                        </div><!-- /.box-body -->
                    </div><!-- /. box -->
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <table id="support_table" class="table table-hover table-striped table-responsive text-center">
                                <thead>
                                <tr>
                                    <th><input type="checkbox" title="Tümünü Seç"></th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-date">
                                            <div class="mailbox-controls">
                                                ...
                                                <div class="btn-group">
                                                    @if($deleg['d'] == 1)
                                                        <a href="#"  class="btn btn-danger btn-sm" title="Çöpe Gönder"><i class="fa fa-trash-o"></i></a>
                                                    @endif
                                                    <button class="btn btn-primary btn-sm" title="Yanıtla"><i class="fa fa-reply"></i></button>
                                                </div><!-- /.btn-group -->
                                            </div>
                                        </td>
                                    </tr>
