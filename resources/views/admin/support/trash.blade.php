              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    ...
                    <div class="btn-group">
                      <button class="btn btn-default btn-sm" onclick="undoDeleteCheckedMessages()"><i class="fa fa-backward"></i></button>
                    </div><!-- /.btn-group -->
                    <button class="btn btn-default btn-sm" onclick="loadSupportPage('trash')"><i class="fa fa-refresh"></i></button>
